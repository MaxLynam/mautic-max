...
$inputAttr = 'id="mauticform_input_' . $field['alias'] . '" name="' . $field['alias'] . '[]" value="' . $field['defaultValue'] . '" ' . $field['inputAttributes'];
...
<div class="mauticform-row mauticform-<?php echo $type . $containerClass; ?> mauticform-row-<?php echo $field['alias']; ?>" id="mauticform_<?php echo $id; ?>">
    ...
    <input <?php echo $inputAttr; ?> type="<?php echo $type; ?>" multiple="multiple" directories="<?php echo $properties['directory'];?>" allowtype="<?php if(isset($properties['AllowType'])){

		foreach($properties['AllowType'] as $key=>$value)
